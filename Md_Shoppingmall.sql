...
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user2','6000','상품구매 5% 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user3','2835','상품구매 5% 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user4','3610','상품구매 5% 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user5','3000','이벤트 응모 3000 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user6','1000','회원가입 1000 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user7','2000','이벤트 응모 2000 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user8','2615','상품구매 5% 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user9','1500','이벤트 응모 1500 적립',now());
insert into `Points` (`userId`,`point`,`pointdesc`,`pointdate`) values ('user10','15840','상품구매 2% 적립',now());
...
insert into `Products` values (110101,10,10003,'신상 여성 운동화',160,76000,40,5);
...
insert into `Orders` values (22010710110,'user9',94500,'광주 충열로 11',1,now());
